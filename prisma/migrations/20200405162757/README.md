# Migration `20200405162757`

This migration has been generated by Jakob H Laverdiere <devjakob@gmail.com> at 4/5/2020, 4:27:58 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE `onepace`.`Episode` ADD COLUMN `streams_hash` varchar(191)   ;
```
...
migration 20200405133459..20200405162757
--- datamodel.dml
+++ datamodel.dml
@@ -6,27 +6,27 @@
